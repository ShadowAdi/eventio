...
export default function EventEditFormPage() {
    ...
    useEffect(() => {
        async function fetchEventData() {
            ...
            if (eventId) {
                const existingEvent = await getEventById(Number(eventId));
                setTimeout(() => {
                    form.reset(eventToFormValues(existingEvent.event));
                }, 500);
            }
        }
        fetchEventData();
